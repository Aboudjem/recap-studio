...
# Run all tests across all packages (73 tests, six workspace projects)
pnpm -w test
# or: pnpm test
...
Total: 73 tests across six workspace projects (`design-system` ships no tests; it is consumed by `recap-web`).
